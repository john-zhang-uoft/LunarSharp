    ...
    public static class Gan_Test
    {
        public static void Main()
        {
            ...
            Model discriminator = new Model(
                new Dense(inputShape: 784, shape: 128, ActivationFunctions.ReLU),
            ...
            void TrainStep(Matrix[] images, out float discLoss, out float genLoss)
            {
                ...
                ImageIO.SaveBitmapAsPNG(bitmap,  $@"C:\Users\johnz\RiderProjects\JohnsNeuralSharp\NeuralSharp\NeuralSharp\GAN_Images\TrainStep_{tx}.png");
                tx++;
            }
