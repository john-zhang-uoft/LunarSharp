...
namespace NeuralSharp
{
    ...
    /// </summary>
    public class DropoutDense : Layer
    {
        ...
        public DropoutDense(int shape, float rate, ActivationFunctions activation = ActivationFunctions.None) : base(
        ...
        /// <param name="activation"></param>
        /// <exception cref="InvalidDataException"></exception>
        public DropoutDense(int inputShape, int shape, float rate, ActivationFunctions activation = ActivationFunctions.None) : base(
